...
\usepackage{mdwlist}
% ltablex kombiniert tabularx mit longtable (Seitenumbruch bei X-Spalte)
\usepackage{ltablex}
\keepXColumns % verhindert, dass ltablex aus X stillschweigend feste Spalten macht
...
%-----------------------------------
% Disclaimer (KI-Nutzung) – auf eigener Seite
%-----------------------------------
\newpage
...
\begin{itemize}
  \item \textbf{Claude (Anthropic):} Verwendet f\"ur Textoptimierung, Strukturierung der Gliederung, Entwicklung von Forschungsfragen und methodische Ausarbeitung
