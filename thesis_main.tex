...
\begin{itemize}
  \item \textbf{Claude (Anthropic) / DeepSeek:} Verwendet \"uber die OpenClaw-Plattform f\"ur Textoptimierung, Strukturierung der Gliederung, Entwicklung von Forschungsfragen und methodische Ausarbeitung
