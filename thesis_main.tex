...
%-----------------------------------
\input{kapitel/disclaimer/disclaimer}
...
Im Rahmen der Erstellung dieser Arbeit wurden moderne digitale Hilfsmittel und KI-basierte Systeme genutzt, um den Forschungs- und Schreibprozess effizient zu unterstützen. Dabei wurden die aktuellen Vorgaben der FOM Hochschule f\"ur Oekonomie und Management die DFG-Leitlinien zur Sicherung guter wissenschaftlicher Praxis (Kodex 2023) sowie die Datenschutzbestimmungen der DSGVO strikt eingehalten.
...
\begin{itemize}
  \item \textbf{Textoptimierung:} Verbesserung von Formulierungen, Umformulierung von Textpassagen und Optimierung der Lesbarkeit
  \item \textbf{Entwicklung von Inhalten:} Unterst\"utzung bei der Entwicklung und Bewertung von Titeln sowie Forschungsfragen
  \item \textbf{Methodik und Gliederung:} Strukturierung, methodische Ausarbeitung und logischer Aufbau der Arbeit
  \item \textbf{Literaturarbeit:} Unterst\"utzung bei der Recherche, Zusammenfassung und Einarbeitung wissenschaftlicher Artikel sowie Sicherstellung der Zitierkonsistenz
  \item \textbf{Qualit\"atspr\"ufung:} \"Uberpr\"ufung auf formale Korrektheit und Einhaltung des FOM-Zitierleitfadens
\end{itemize}
...
Es wurden die folgenden digitalen Werkzeuge und KI-Sprachmodelle genutzt:

\begin{itemize}
  \item \textbf{Claude (Anthropic):} Verwendet \"uber die OpenClaw-Plattform f\"ur Textoptimierung, Strukturierung der Gliederung, Entwicklung von Forschungsfragen und methodische Ausarbeitung
...
Mit dieser Erkl\"arung m\"ochte ich gr\"o\ss{}tm\"ogliche Transparenz \"uber den Einsatz moderner Technologien schaffen. Ich versichere, dass die vorliegende Arbeit trotz der digitalen Unterst\"utzung meine eigenst\"andige wissenschaftliche Leistung darstellt und alle Anforderungen an ein Expos\'e erf\"ullt.
\vspace{1cm}
\noindent D\"usseldorf, 23. Juni 2026 \hfill Unterschrift: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\n\vspace{0.5cm}
